...
// 自己unitId
	...
	[ResponseType(nameof(C2A_GetServerInfos))]
	...
	public partial class RoleInfoProto: Object
	{
		...
		[ProtoMember(10)]
		public long RoleExp { get; set; }

		[ProtoMember(11)]
		public long PhysicalAttack { get; set; }

		[ProtoMember(12)]
		public long SpellAttack { get; set; }

		[ProtoMember(13)]
		public long PhysicalDefense { get; set; }

		[ProtoMember(14)]
		public long SpellDefense { get; set; }
...
/// ------------------------------------ 协议测试 ----------------------------//
	[Message(OuterOpcode.C2M_TestCreateItem)]
	[ProtoContract]
	public partial class C2M_TestCreateItem: Object, IActorLocationMessage
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.C2M_TestStartBattle)]
	[ProtoContract]
	public partial class C2M_TestStartBattle: Object, IActorLocationMessage
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
...
/// --------------------------------------Rank服--------RankHelper--------------------//
	...
	[ResponseType(nameof(M2C_CreateBattle))]
	[Message(OuterOpcode.C2M_CreateBattle)]
	[ProtoContract]
	public partial class C2M_CreateBattle: Object, IActorLocationRequest
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.M2C_CreateBattle)]
	[ProtoContract]
	public partial class M2C_CreateBattle: Object, IActorLocationResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
		...
		[ProtoMember(1)]
		public List<UnitInfo> Fighters = new List<UnitInfo>();

	}

	[ResponseType(nameof(M2C_GetBattleRecord))]
	[Message(OuterOpcode.C2M_GetBattleRecord)]
	[ProtoContract]
	public partial class C2M_GetBattleRecord: Object, IActorLocationRequest
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
...
// 一次出手引造成的伤害记录
	[Message(OuterOpcode.M2C_GetBattleRecord)]
	[ProtoContract]
	public partial class M2C_GetBattleRecord: Object, IActorLocationResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
		...
		[ProtoMember(1)]
		public List<OneBattleRecord> OneBattleRecords = new List<OneBattleRecord>();

	}

	[Message(OuterOpcode.OneBattleRecord)]
	[ProtoContract]
	public partial class OneBattleRecord: Object
	{
		[ProtoMember(1)]
		...
		[ProtoMember(4)]
		public List<BattleEffectTarget> Targets = new List<BattleEffectTarget>();

	}

	[Message(OuterOpcode.BattleEffectTarget)]
	[ProtoContract]
	public partial class BattleEffectTarget: Object
	{
		[ProtoMember(1)]
...
// 由于技能导致的数值变化
		[ProtoMember(2)]
		public BattlePhysicalAttackChange BattlePhysicalAttackChangeBySkill { get; set; }

		[ProtoMember(3)]
		public BattlePhysicalDefenseChange BattlePhysicalDefenseChangeBySkill { get; set; }

		[ProtoMember(4)]
		public BattleSpellAttackChange BattleSpellAttackChangeBySkill { get; set; }

		[ProtoMember(5)]
		public BattleSpellDefenseChange BattleSpellDefenseChangeBySkill { get; set; }

		[ProtoMember(6)]
		public BattleSpeedChange BattleSpeedChangeBySkill { get; set; }

		[ProtoMember(7)]
		public BattleHpChange BattleHpChangeBySkill { get; set; }
...
// 状态变更
		...
		[ProtoMember(9)]
		public BattlePhysicalAttackChange BattlePhysicalAttackChangeByState { get; set; }

		[ProtoMember(10)]
		public BattlePhysicalDefenseChange BattlePhysicalDefenseChangeByState { get; set; }

		[ProtoMember(11)]
		public BattleSpellAttackChange BattleSpellAttackChangeByState { get; set; }

		[ProtoMember(12)]
		public BattleSpellDefenseChange BattleSpellDefenseChangeByState { get; set; }

		[ProtoMember(13)]
		public BattleSpeedChange BattleSpeedChangeByState { get; set; }

		[ProtoMember(14)]
		public BattleHpChange BattleHpChangeByState { get; set; }

	}

// 造成的跟物理攻击有关的变化
	[Message(OuterOpcode.BattlePhysicalAttackChange)]
	[ProtoContract]
	public partial class BattlePhysicalAttackChange: Object
	{
		[ProtoMember(1)]
...
// 造成的跟物理防御有关的变化
	[Message(OuterOpcode.BattlePhysicalDefenseChange)]
	[ProtoContract]
	public partial class BattlePhysicalDefenseChange: Object
	{
		[ProtoMember(1)]
		public int ChangeType { get; set; }
...
// 造成的跟法术攻击有关的变化
	[Message(OuterOpcode.BattleSpellAttackChange)]
	[ProtoContract]
	public partial class BattleSpellAttackChange: Object
	{
		[ProtoMember(1)]
		public int ChangeType { get; set; }
...
// 造成的跟法术防御有关的变化
	[Message(OuterOpcode.BattleSpellDefenseChange)]
	[ProtoContract]
	public partial class BattleSpellDefenseChange: Object
	{
		[ProtoMember(1)]
		public int ChangeType { get; set; }
...
// 造成的跟速度有关的变化
	[Message(OuterOpcode.BattleSpeedChange)]
	[ProtoContract]
	public partial class BattleSpeedChange: Object
	{
		[ProtoMember(1)]
		public int ChangeType { get; set; }
...
// 造成的跟气血有关的变化
	[Message(OuterOpcode.BattleHpChange)]
	[ProtoContract]
	public partial class BattleHpChange: Object
	{
		[ProtoMember(1)]
		public int ChangeType { get; set; }
	...
	[Message(OuterOpcode.StateChange)]
	[ProtoContract]
	public partial class StateChange: Object
	{
		[ProtoMember(1)]
