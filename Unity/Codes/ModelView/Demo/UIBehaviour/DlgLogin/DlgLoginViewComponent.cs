		...
		public UnityEngine.UI.InputField E_AccountInputField
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_AccountInputField = UIFindHelper.FindDeepChild<UnityEngine.UI.InputField>(this.uiTransform.gameObject,"Sprite_BackGround/Image/Placeholder/E_Account");
     			}
		...
		public UnityEngine.UI.Image E_AccountImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_AccountImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Sprite_BackGround/Image/Placeholder/E_Account");
     			}
		...
		public UnityEngine.UI.InputField E_PasswordInputField
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PasswordInputField = UIFindHelper.FindDeepChild<UnityEngine.UI.InputField>(this.uiTransform.gameObject,"Sprite_BackGround/Image/Placeholder/E_Password");
     			}
		...
		public UnityEngine.UI.Image E_PasswordImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PasswordImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Sprite_BackGround/Image/Placeholder/E_Password");
     			}
		...
		public UnityEngine.UI.Button E_LoginButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_LoginButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Sprite_BackGround/Image/E_Login");
     			}
		...
		public UnityEngine.UI.Image E_LoginImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_LoginImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Sprite_BackGround/Image/E_Login");
     			}
