...
namespace ET
{
    ...
    public static class ServerInfoSystem
    {
        public static void FromMessage(this ServerInfo self, ServerInfoProto serverInfoProto)
        {
            ...
            self.Int_Status = serverInfoProto.Status;
            self.Str_ServerName = serverInfoProto.ServerName;
        }

        public static ServerInfoProto ToMessage(this ServerInfo self)
        {
            return new ServerInfoProto() { Id = (int)self.Id, ServerName = (string)self.Str_ServerName, Status = self.Int_Status};
        }
    }
}
